(function(){ if (!window.customElements.get('virtual-joystick')) {
window.customElements.define('virtual-joystick', class VirtualJoystick extends HTMLElement {
   ...
   #isInside(event) {
    ...
    connectedCallback() {
        // Daftarkan ke elemen host agar joystick bekerja saat user berinteraksi di area joystick,
        // namun tetap dukung mode dynamic/fixed sesuai library dengan fallback ke document.
